...
Nenhuma oportunidade atingiu `URGENTE` (que exige prazo em até 7 dias) nem `ALTA_PRIORIDADE` (que exige score ≥ 75 e confiança ≥ 0,70); as 8 validadas caíram em `REVISAO`. Ainda assim, três chamadas vencem em 10–11 dias — VIDEOCLIPE-SE em 30/09/2026 e as duas do Ibermúsicas em 01/10/2026 — e ficam fora do alerta `URGENTE` por pouco, merecendo tratamento manual de urgência mesmo sem acionar a regra. Apenas uma validada alcançou score ≥ 60 (Funarte Aberta, 63), e três das oito têm status `DESCONHECIDA` por bloqueio técnico de fonte.
...
Observação: as três chamadas com prazo em 10–11 dias listadas abaixo não acionam a regra `URGENTE`, mas devem receber tratamento manual de urgência.

| Título | Prazo | Decisão | Por que não é `URGENTE` |
|---|---|---|---|
| VIDEOCLIPE-SE Festival — 4ª edição | 30/09/2026 (hora e fuso não localizados) | Aplicar (condicional) | Prazo em 10 dias, acima do limite de 7 dias |
...
|---|---|---|---|---|---|---:|---|---:|---|---|---|---|---|
| VIDEOCLIPE-SE Festival — 4ª edição | Limonada Audiovisual, com Maria Bonita Filmes | Brasil — MG/BH; Mostra Competitiva nacional (20 selecionados) e Chamada de Produção restrita a BH e região metropolitana | Mostra competitiva de videoclipe | R$ 500,00 por prêmio, em quatro categorias. Inscrição gratuita. Moeda: BRL | 30/09/2026 (item 3.1). Hora e fuso não localizados. **Conflito interno no regulamento oficial:** o cronograma do item 8 diz 30/10/2026 — 30/09 tratado como prazo operacional | 54 | Aplicar (condicional) | 0,66 | Regulamento lido; aberta a PF maior de 18 anos ou PJ de qualquer estado; inscrição gratuita; a obra já precisa existir, não há produção a financiar | O conflito de datas dentro do próprio regulamento; e a contrapartida do item 6.1.II, que autoriza exibição e reprodução no site do festival "sem limite de tempo ou de número de exibições". Condicionante: depende de a Dhara ter videoclipe produzido no Brasil e lançado a partir de 2020 — dado não fornecido | Confirmar se existe videoclipe elegível e escrever hoje à organização pedindo a data correta e o horário-limite, por escrito. Inscrever até 29/09 | https://www.videoclipesefestival.com.br/ | https://www.videoclipesefestival.com.br/regulamento/ |
...
Status validado e operacional: **Aberta** para Funarte Aberta, VIDEOCLIPE-SE, as duas chamadas do Ibermúsicas e a residência Institut français x Cité; **Desconhecida** para Ambev Brasilidades, Tallinn Music Week e Embratur. Fonte oficial não confirmada em Tallinn Music Week e Embratur; parcial no Ambev Brasilidades.

## 4. Atualizações

Mudanças de prazo, status, regulamento, valor ou elegibilidade em oportunidades já conhecidas.

_Nenhuma atualização nesta rodada._ Primeira rodada: `data/reports/` estava vazio, as 8 validadas são novas e não há encerramentos a registrar. Nenhuma duplicata — as duas linhas do Ibermúsicas são chamadas distintas da mesma convocatória.
...
| VIDEOCLIPE-SE Festival — 4ª edição | Conflito de datas dentro do regulamento oficial: item 3.1 diz 30/09/2026, cronograma do item 8 diz 30/10/2026. Hora e fuso não localizados | Conflito entre seções do regulamento; prazo e horário ambíguos | https://www.videoclipesefestival.com.br/regulamento/ |
...
2. Escrever hoje à organização do VIDEOCLIPE-SE pedindo, por escrito, a data correta e o horário-limite, dado o conflito entre os itens 3.1 e 8 do regulamento.
...
- **Prazos não confirmados:** Ambev Brasilidades, Tallinn Music Week e Embratur. Conflito interno de datas no regulamento do VIDEOCLIPE-SE. Fuso ambíguo nas duas chamadas do Ibermúsicas.
...
- **Perguntas eliminatórias** (cada resposta destrava ou encerra uma decisão inteira):
  1. A Dhara tem videoclipe produzido no Brasil e lançado a partir de 2020? Decide a inscrição no VIDEOCLIPE-SE, cujo prazo operacional é 30/09/2026.
